...
<section class="header">
    <div class="logo">
        ...
        <h2><span>美妆管理系统</span></h2>
    </div>
</section>
<section class="main">
    <div class="sidebar">
        <ul class="sidebar--items">
            <li class="good-manage">
                <a href="#" id="active--link" class="good">
                    <span class="icon icon-1"><i class="el-icon-s-home"></i></span>
                    <span class="sidebar--item ">商品管理</span>
                    <ion-icon name="chevron-down-outline" class="collapse__link" ></ion-icon>
                </a>
                <ul class="child-menu sidebar--items">
                    <li id="Good-Check" class="child-menu-item sidebar--item" id="Good-Check">商品审核</li>
                    <li id="Good-roost" class="child-menu-item sidebar--item" id="Good-roost">已上架商品管理</li>
                </ul>
            </li>
            <li>
                <a href="#"  id="Order">
            ...
            <li>
                <a href="#" id="Cooperate">
                    ...
                    <span class="sidebar--item">合作管理</span>
                </a>
            </li>
            <li>
                <a href="#" class="user">
                    ...
                    <span class="sidebar--item">用户管理</span>
                    <ion-icon name="chevron-down-outline" class="collapse__link" ></ion-icon>
                </a>
                <ul class="sidebar--items user-menu">
                    <li class="sidebar--item user-menu-item" id="User-user">买家管理</li>
                    <li class="sidebar--item user-menu-item" id="User-Shopper">卖家管理</li>
                    <li class="sidebar--item user-menu-item" id="User-Admin">管理员管理</li>
                </ul>
            </li>
            <li>
    ...
    <div class="main--content">
        <iframe style="position: absolute;width: 100%;height: 100%;" src="Admin/Blank.jsp"></iframe>
    </div>
</section>
...
<script>
    ...
    $(function (){
        $('#Complain').click(function (){
            $('iframe').attr('src','Admin/Complain.jsp');
        })
    });
    $(function (){
        $('#Cooperate').click(function (){
            $('#Cooperate').css("background-color","#5073fb");
            $('#Good-roost').css("background-color","#324057");
            $('#Order').css("background-color","#324057");
            $('#User-Admin').css("background-color","#324057");
            $('#User-Shopper').css("background-color","#324057");
            $('#User-user').css("background-color","#324057");
            $('#SelfCenter').css("background-color","#324057");
            $('#Good-Check').css("background-color","#324057");
            $('iframe').attr('src','Admin/Cooperate.jsp');
        })
    });
    $(function (){
        $('#Good-Check').click(function (){
            $('#Good-Check').css("background-color","#5073fb");
            $('#Good-roost').css("background-color","#324057");
            $('#Order').css("background-color","#324057");
            $('#User-Admin').css("background-color","#324057");
            $('#User-Shopper').css("background-color","#324057");
            $('#User-user').css("background-color","#324057");
            $('#SelfCenter').css("background-color","#324057");
            $('#Cooperate').css("background-color","#324057");
            $('iframe').attr('src','Admin/Good-Check.jsp');

        })
    });
    $(function (){
        $('#Good-roost').click(function (){
            $('#Good-roost').css("background-color","#5073fb");
            $('#Good-Check').css("background-color","#324057");
            $('#Order').css("background-color","#324057");
            $('#User-Admin').css("background-color","#324057");
            $('#User-Shopper').css("background-color","#324057");
            ...
            $('#SelfCenter').css("background-color","#324057");
            $('#Cooperate').css("background-color","#324057");
            $('iframe').attr('src','Admin/Good-roost.jsp');
        })
    });
    $(function (){
        $('#LiuYanMessage').click(function (){
            $('iframe').attr('src','Admin/LiuYanMessage.jsp');
        })
    });
    $(function (){
        $('#Order').click(function (){
            $('#Order').css("background-color","#5073fb");
            $('#Good-roost').css("background-color","#324057");
            $('#Good-Check').css("background-color","#324057");
            $('#User-Admin').css("background-color","#324057");
            $('#User-Shopper').css("background-color","#324057");
            ...
            $('#SelfCenter').css("background-color","#324057");
            $('#Cooperate').css("background-color","#324057");
            $('iframe').attr('src','Admin/Order.jsp');
        })
    });
    // $(function (){
    //     $('#Promote').click(function (){
    //         $('iframe').attr('src','Admin/Promote.jsp');
    //     })
    // });
    $(function (){
        $('#SelfCenter').click(function (){
            ...
            $('#Good-Check').css("background-color","#324057");
            $('#Cooperate').css("background-color","#324057");
            $('iframe').attr('src','Admin/SelfCenter.jsp');
        })
    });
    $(function (){
        $('#User-Admin').click(function (){
            $('#User-Admin').css("background-color","#5073fb");
            $('#Good-roost').css("background-color","#324057");
            $('#Order').css("background-color","#324057");
            $('#Good-Check').css("background-color","#324057");
            $('#User-Shopper').css("background-color","#324057");
            ...
            $('#SelfCenter').css("background-color","#324057");
            $('#Cooperate').css("background-color","#324057");
            $('iframe').attr('src','Admin/User-Admin.jsp');
        })
    });
    $(function (){
        $('#User-Shopper').click(function (){
            $('#User-Shopper').css("background-color","#5073fb");
            $('#Good-roost').css("background-color","#324057");
            $('#Order').css("background-color","#324057");
            $('#User-Admin').css("background-color","#324057");
            $('#Good-Check').css("background-color","#324057");
            ...
            $('#SelfCenter').css("background-color","#324057");
            $('#Cooperate').css("background-color","#324057");
            $('iframe').attr('src','Admin/User-Shopper.jsp');
        })
    });
    $(function (){
        $('#User-user').click(function (){
            $('#User-user').css("background-color","#5073fb");
            $('#Good-roost').css("background-color","#324057");
            $('#Order').css("background-color","#324057");
            $('#User-Admin').css("background-color","#324057");
            $('#User-Shopper').css("background-color","#324057");
            ...
            $('#SelfCenter').css("background-color","#324057");
            $('#Cooperate').css("background-color","#324057");
            $('iframe').attr('src','Admin/User-user.jsp');
        })
    });
</script>
</body>
