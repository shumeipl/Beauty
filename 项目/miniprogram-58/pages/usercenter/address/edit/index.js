...
Page({
  ...
  onLoad(options) {
    ...
    this.setData({
     "locationState.name":options.name,
     "locationState.phone":options.phone,
     "locationState.provinceName":options.provinceName,
     "locationState.cityName":options.cityName,
     "locationState.districtName":options.districtName,
     "locationState.addressId":options.addressId,
     "locationState.detailAddress":options.detailAddress,
     "locationState.addressTag":options.addressTag,
     "locationState.isDefault":options.isDefault==1?true:false,
    });
    const { id } = options;
    this.init(id);
  },
  ...
  formSubmit() {
    ...
    console.log(this.data.locationState.addressId);
    if(this.data.locationState.addressId!=undefined){
      console.log(1);
      // 修改
    wx.request({
      url: 'http://localhost:8081/PATCH/Address',
      method:'POST',
      data:{
        userId:app.globalData.userInfo.userId,
        name:this.data.locationState.name,
        tel:this.data.locationState.phone,
        addressId: this.data.locationState.addressId,
        detailAddress:this.data.locationState.detailAddress,
        tag:this.data.locationState.addressTag==undefined?0:this.data.locationState.addressTag,
        addressDefault:this.data.locationState.isDefault==true?1:0,
        countryName:this.data.locationState.countryName,
        provinceName:this.data.locationState.provinceName,
        cityName:this.data.locationState.cityName,
        districtName:this.data.locationState.districtName
      },
      header:{
      ...
      // 新增
      wx.request({
        url: 'http://localhost:8081/PUT/Address',
        data:{
          userId:app.globalData.userInfo.userId,
          name:this.data.locationState.name,
          tel:this.data.locationState.phone,
